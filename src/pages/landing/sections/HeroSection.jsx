            ...
            <div className="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
              <div className="w-full max-w-xl lg:shrink-0 xl:max-w-2xl">
                ...
                <p className="relative mt-6 text-lg leading-8 text-gray-600 sm:max-w-md lg:max-w-none">
                  Focus on your specific goals with our guided courses,
                  including academic test prep, business English, conversation
                  practice, and more.
                </p>
                  ...
                  <form noValidate>
                    <div className="flex">
                      <input
                        ...
                        className="flex-1 rounded-s-lg border-0 py-1.5 text-black shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-600 focus:ring-2 focus:ring-inset focus:ring-secondary-600 sm:text-sm sm:leading-6"
                        type="search"
