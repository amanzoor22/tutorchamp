...
const Coments = () => {
  return (
    <div>
      <div className="font-sans lg:px-4 pb-16  max-w-3xl flex flex-col bg-white px-2 py-4">
        ...
        <div className="-my-10 ">
          <div className="flex space-x-4">
            ...
            <div className="flex-1 py-10">
              <h3 className="font-medium text-gray-900">Joel</h3>
              ...
              <div className=" mt-4 max-w-none text-base">
                <p>
                  Hi! I'm Joel. I’m an English language teacher , editor, and
          ...
          <div className="flex space-x-4">
            ...
            <div className="flex-1 py-10">
              ...
              <div className=" mt-4 max-w-none text-base">
                <p>
                  Joel is an excellent teacher!! Besides being knowledgeable he
